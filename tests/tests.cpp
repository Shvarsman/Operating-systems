/*
Выполнил Шварцман Дидар Азатович
Код реализует тесты для функций вычисления факториалов, 
удаления дубликатов из вектора и реверсирования связного списка 
с использованием библиотеки Google Test для проверки корректности их работы.
 */
